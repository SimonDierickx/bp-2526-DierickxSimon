...
\begin{figure}[H]
  ...
  \caption[Link stability at 18.5\,km.]{\label{fig:poc-snr-stab}The same 1\,015 packets from the staionary test, plotted against their sequence number (from 1 to 342, 341 received: 99.7\,\% \gls{pdr}). After some initial variation, the link stabilised around $+6$\,dB and delivered 341 of 342 packets (99.7\,\% \gls{pdr}), showing the maximum-range link was sustainable.}
\end{figure}
