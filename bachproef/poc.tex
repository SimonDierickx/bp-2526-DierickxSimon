...
The main power source was a 6\,W 5\,V/1\,A solar panel, the size of this panel ($27.1 \times 17.5 \times 0.26$\,cm) allows it to be easily mounted and directed to the sun.
...
For the EU\_868 band this means 27\,dBm, that's why table~\ref{tab:poc-config} and appendix~\ref{ch:bijlage-configuratie} report 27\,dBm.
...
What can be seen is that, altough the link was successful, the quality of the connection was degraded, so this should be further investigated.