...
This means that the battery could in reality sustain 4x ±8 hours, which means 24 hours of total operation. This is a good result, as the battery then charges when sunlight hits it. This means the battery could cover a night + a partially clear sky for example.
