...
\IfLanguageName{english}{%
    ...
    \degreesought{Bachelor in de toegepaste informatica}%
...
%%---------- Andere bijlagen --------------------------------------------------
\input{bijlage-configuratie}
\input{bijlage-rangetest}
\input{bijlage-veldnotities}
\input{bijlage-screenshots}
