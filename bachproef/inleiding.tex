...
Several technologies already exists, but they all have their limiations which make them difficult to effectively apply in an emergency.
...
The primary audience are IT professionals that are responsible for continuity and civil protection communication, such as security teams etc.
...
Chapter~\ref{ch:stand-van-zaken} covers the state of the art. It defines problem and solution domains, reviews the existing alternatives (APRS, DMR and satellite messengers) and explains the technical background of \gls{lora} and Meshtastic.

Chapter~\ref{ch:methodologie} describes how the project is set up, and how everythign will be executed, as well as the choices that have been made.
