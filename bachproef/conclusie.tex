...
This thesis started by investigating to what extent does Meshtastic, as a decentralized \gls{lora}-based mesh network, offers a reliable and readily deployable emergency communication solution when primary network infrastructure fails.
...
The \gls{poc} also proved a relay could convert a dead zone connection into a working connection (session 1 compared to session 3). When comparing against the five inital requirements the literature study gave us in chapter~\ref{ch:stand-van-zaken}, Meshtastic can be seen as a realistic alternative.
