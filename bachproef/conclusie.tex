...
Some limitations can also be noted. The only tested hardware was the Heltec WiFi LoRa 32 V4; \gls{aprs}, \gls{dmr}, satellite messengers were only evaluated through literature study. Also other ESP32 options exist but weren't tested. They should work in the same way this \gls{poc} was done.
