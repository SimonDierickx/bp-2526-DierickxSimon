...
\begin{table}[h]
  ...
  \begin{tabular}{lccc}
    ...
    Update interval         & 1800\,s      & 1800\,s     & 1800\,s \\
...
Section~\ref{sec:poc-security}. The channel name and PSK are identical across all three
nodes so that they can communicate; the PSK itself is not reproduced here for obvious
reasons.
