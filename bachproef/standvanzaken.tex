...
A device wanting to participate in said channel, must have the smae channel name and \gls{psk} configured. Eight different channels can be configured on a single node simultaneously, one primary and seven seocndary channels, each with its own key \autocite{MeshtasticChanels}.
